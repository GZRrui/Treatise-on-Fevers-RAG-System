...
基于 LlamaIndex、FastAPI 和 Vue 3 的《伤寒论》检索增强问答系统。阶段0已按 Windows 目标环境完成原始系统基线验收；当前开始阶段1的模块化单体与主链路缺陷修复，尚未签收阶段1。

## 运行时

- Python `3.11`（本机验收 `3.11.15`；GitHub Windows 2025 runner 使用其最新可安装补丁版 `3.11.9`）
- Node.js `22.17.0`
- npm `10.9.2`
